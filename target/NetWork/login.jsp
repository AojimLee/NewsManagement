    ...
    <div class="publicwidth">
        <div class="fr" id="form">
            ...
            <form action = "/LoginServlet" method = "post">
                ...
                <div class="inputbox">
                    <input placeholder="密码" name = "password" value="" id="input2" type = "password" onblur="showwarming()" onfocus="hidewarming()" />
                </div>
                <div class="btnbox">
        ...
        <div class="fr" id="form2">
            ...
            <form action = "/ManagerLoginServlet" method = "post">
                ...
                <div class="inputbox">
                    <input placeholder="管理员密码" name = "password" type = "password" value="" id="input2" onblur="showwarming()" onfocus="hidewarming()" />
                </div>
                <div class="btnbox">
                    <input type="submit" value="立即登陆" />
                </div>
